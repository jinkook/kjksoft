...
kjksoft의 어플리케이션은 개인정보보호법에 따라 이용자들의 개인정보 보호 및 권익을 보호하고자 다음과 같은 처리방침을 두고 있습니다.
...
당사는 Android 서비스 기능을 이용하기 위한 기능과 리워드용 광고서비스 등에서 특정 개인과 직접적인 관련이 없는, 개인식별이 불가능한 정보를 수집할 수 있습니다.
...
당사의 어플리케이션은 모두 해당 미디어서비스(구글,광고미디어)의 SDK를 통해 간접적으로 이용합니다.
...
admob SDK for Android 제공 회사 : Google Inc 이용 목적 : 광고 게재 제공 항목 : 개인 식별이 불가능한 광고식별자(Android 광고 ID)

9.개인정보 보호책임자 작성

이메일 : jinkooknv@gmail.com
